function image_filter_gui
    ...
    % Callback functions
    function loadImage(~,~)
        filePath = '/MATLAB Drive/Color-image-baboon-and-its-gray-valued-representation-used-as-transparency.png';
        if ~isfile(filePath)
            errordlg('/MATLAB Drive/Color-image-baboon-and-its-gray-valued-representation-used-as-transparency.png','File Error');
            return;
        end
